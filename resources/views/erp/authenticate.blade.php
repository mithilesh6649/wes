        ...
        <div id="admin" class="active tab-pane">
            <div class="alert alert-warning">
                 <i class="fa fa-warning text-dark"></i>
                  Register admin panel from your personal pc. Once you 
                  register,you will only access your admin panel form this pc
                  <i class="fa fa-times-circle close mt-2 text-danger" data-dismiss="alert" style="cursor: pointer;"></i> 
            </div>
